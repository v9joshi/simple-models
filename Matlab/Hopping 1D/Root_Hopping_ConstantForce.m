% Program to Simulate hopper with constant force during contact phase
function outputStruct = Root_Hopping_ConstantForce(y0, v0, m , g, L0, F0, doPlots)
    % % Parameters
    % g = 10; F0 = 1400; L0 = 1; m = 70;

    % Packing
    params.g = g; params.F0 = F0; params.L0 = L0; params.m = m;
    ...
    ODE_contact = @(t,statevar) ODE_Contact_ConstantForce(t,statevar,params);
    ...
    %save('hopper_constant_force.mat','tlist','vlist','ylist','Flist')
    outputStruct.tlist = tlist;
    outputStruct.ylist = ylist;
    outputStruct.vlist = vlist;
    outputStruct.Flist = Flist;
